...
class PostController extends AbstractController
{
    public function index(DatatableBuilderInterface $builder): Response
    {
        $datatable = $builder->createDatatableFromArray(
            [
                new TextColumn('Name'),
                new TextColumn('Position'),
                new TextColumn('Office'),
                new TextColumn('Extn'),
                new TextColumn('Start date'),
                new TextColumn('Salary'),
            ],
            [
    ...
    public function empty(DatatableBuilderInterface $builder): Response
    {
        $datatable = $builder->createDatatableFromArray(
            [
                new TextColumn('Name'),
